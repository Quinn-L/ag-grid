...
export class PopupService {
    ...
    public addAsModalPopup(eChild: HTMLElement, closeOnEsc: boolean, closedCallback?: ()=>void): (event?: any)=>void {
        ...
        function hidePopup(event?: any) {
            ...
            let parentNode = eChild.parentNode;
            parentNode.removeChild(eChild);
